...
export const state: AppState = {
  ...
  workItems: [
    ...
    },
    {
      ...
      description: 'Summarize shipped changes and open risks for the release email.',
      priority: 'Medium',
      durationMinutes: 30,
    ...
    },
    {
      ...
      description: 'Review flaky coverage and separate environment noise from regressions.',
      priority: 'High',
      durationMinutes: 60,
    ...
    {
      id: 'work-6',
      title: 'Refine backlog estimates',
      description: 'Update estimates for the next planning session with current capacity.',
      priority: 'Low',
      durationMinutes: 45,
      requiredSkills: ['Product'],
      targetDate: initialDate,
    ...
    },
    {
      ...
      description: 'Check the latest deployment and capture any production warnings.',
      priority: 'Medium',
      durationMinutes: 30,
      requiredSkills: ['Ops'],
      targetDate: initialDate,
    ...
    },
    {
      ...
      description: 'Make the initial user guidance shorter and easier to scan.',
      priority: 'Low',
      durationMinutes: 45,
      requiredSkills: ['Product', 'React'],
      targetDate: initialDate,
      status: 'unscheduled',
    },
    {
      id: 'work-9',
      title: 'Clean up board spacing',
      description: 'Tighten the card layout and preserve the current selection state.',
      priority: 'Medium',
      durationMinutes: 60,
    ...
    {
      id: 'work-10',
      title: 'Review booking rules',
      description: 'Confirm overlapping assignments stay blocked in the scheduling engine.',
      priority: 'High',
      durationMinutes: 60,
      requiredSkills: ['Testing', 'Node'],
      targetDate: initialDate,
      status: 'unscheduled',
    },
    {
      id: 'work-11',
      title: 'Update availability notes',
      description: 'Capture each resource note so the next planning pass has context.',
      priority: 'Low',
      durationMinutes: 30,
      requiredSkills: ['Product', 'Ops'],
      targetDate: initialDate,
      status: 'unscheduled',
    },
    {
